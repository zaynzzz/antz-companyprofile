...
$users = db_connect()->query('SELECT * FROM users')->getRow();
?>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url(); ?>" class="brand-link">
    <img src="<?= base_url('assets/upload/image/' . $site['icon']) ?>" alt="View Your Website" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-primary"><?= $site['namaweb'] ?></span>
  </a>
  <!-- Sidebar -->
  <div class="sidebar ">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?= base_url() ?>/assets/upload/image/<?= $users->gambar; ?>" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
